...
_ABOUT_LINES = {
    'uk': [
        ...
        ('', 't'),
        ('Джерела даних', 'h'),
        ('Погода, вітер, УФ, прогноз на тиждень — Open-Meteo (api.open-meteo.com), без ключа.', 't'),
        ('Магнітні бурі (Kp) та 3-денний прогноз — NOAA SWPC (services.swpc.noaa.gov).', 't'),
        ('Оновлення ПЗ і дизайнів — GitHub (github.com/Akustik13/rpi-airstation).', 't'),
        ('Температура, вологість, тиск, CO₂, VOC, NOx, пил — локальні датчики по I²C.', 't'),
        ('Фаза місяця, схід/захід сонця, ретроград — рахуються/таблиця офлайн.', 't'),
        ('', 't'),
        ('Екрани та жести', 'h'),
    ...
    'en': [
        ...
        ('', 't'),
        ('Data sources', 'h'),
        ('Weather, wind, UV, weekly forecast — Open-Meteo (api.open-meteo.com), no key.', 't'),
        ('Geomagnetic storms (Kp) and 3-day forecast — NOAA SWPC (services.swpc.noaa.gov).', 't'),
        ('Software & design updates — GitHub (github.com/Akustik13/rpi-airstation).', 't'),
        ('Temperature, humidity, pressure, CO₂, VOC, NOx, dust — local I²C sensors.', 't'),
        ('Moon phase, sunrise/sunset, retrograde — computed/table, offline.', 't'),
        ('', 't'),
        ('Screens & gestures', 'h'),
